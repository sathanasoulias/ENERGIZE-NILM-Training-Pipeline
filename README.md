...
|-----------|---------|-----|----------|
| `boiler` | 13.02 | 0.9197 | 0.9960 |
| `ac_1` | 11.72 | 0.9554 | 0.9934 |
| `washing_machine` | 3.20 | 0.8627 | 0.9860 |

### CNN (Seq2Point)

| Appliance | MAE (W) | F1 | Accuracy |
|-----------|---------|-----|----------|
| `boiler` | 9.84 | 0.9084 | 0.9964 |
| `ac_1` | 17.10 | 0.9460 | 0.9888 |
| `washing_machine` | 3.22 | 0.8294 | 0.9859 |

### GRU (Seq2Point)

| Appliance | MAE (W) | F1 | Accuracy |
|-----------|---------|-----|----------|
| `boiler` | 7.99 | 0.9320 | 0.9975 |
| `ac_1` | 23.29 | 0.9178 | 0.9912 |
| `washing_machine` | 3.37 | 0.8542 | 0.9871 |
